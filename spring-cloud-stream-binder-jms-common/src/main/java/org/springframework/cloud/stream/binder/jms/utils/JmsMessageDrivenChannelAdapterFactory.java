...
//        
//        Jms.messageDrivenChannelAdapter(Jms.con)
//        
//        return adapter;
//    }
//
...
//                MessageRecoverer messageRecoverer, String deadLetterQueueName) {
...
//                .execute(new RetryCallback<Object, JMSException>() {
//
//                    @Override
...
//                            Message message = (Message) retryContext
//                                .getAttribute(RETRY_CONTEXT_MESSAGE_ATTRIBUTE);
...
//        }
//
//        private void resetMessageIfRequired(Message jmsMessage)
//                throws JMSException {
...
//            backOffPolicy
//                .setInitialInterval(properties.getBackOffInitialInterval());
